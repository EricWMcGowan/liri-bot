...
var defaultMovie = "The Lone Survivor";
var defaultSong = "Hotel California";
...
function getMyTweets(){
	...
	var params = {screen_name: 'overshot11', count: 20, exclude_replies:true, trim_user:true};
...
function spotifyThis(song){
	...
	//If user has not specified a song , default to "Hotel California" the eagles
	if(song === ""){
